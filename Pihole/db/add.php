<?php
	...
	$temp1	= isset($_POST['temp1']) ? $_POST['temp1'] : "666";
	$hum_p1	= isset($_POST['hum_p1']) ? $_POST['hum_p1'] : "666";
	$hum_r1	= isset($_POST['hum_r1']) ? $_POST['hum_r1'] : "666";
	$wlan1	= isset($_POST['wlan1']) ? $_POST['wlan1'] : "666";
